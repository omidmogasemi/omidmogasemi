...
- **Komma**, a start-up simplifying the way people schedule meetings. Built using the MERN stack with Google Auth API and AWS S3 for image hosting I was responsible for front-end web development as well as serving as the company's CEO, performing pitches and deriving our early business model. Participated in the Spring 2021 UCD PLASMA accelerator cohort.
